...
contract ARTHValuecoin is Ownable, ERC20, ERC20Permit {
    ...
    event BorrowerOperationsAddressToggled(
        address indexed boAddress,
        bool oldFlag,
        bool newFlag,
        uint256 timestamp
    );
    event TroveManagerToggled(
        address indexed tmAddress,
        bool oldFlag,
        bool newFlag,
        uint256 timestamp
    );
    event StabilityPoolToggled(
    ...
    function toggleBorrowerOperations(address borrowerOperations)
        external
        onlyOwner
    {
